...
-> impl warp::Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    ...
    let route_84 = warp::path("manifest.json")
        .and(warp::get())
    ...
    let route_106 = warp::path("vendor")
        .and(warp::path("js"))
    ...
    .or(
        ...
        .or(((route_100).or((route_101).or(route_102)))
