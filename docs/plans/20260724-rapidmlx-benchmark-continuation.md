...
6. Extend the source Qwen 3.6 35B matrix with explicit 160k and 200k int4 rows before relying on its 32k/65k/131k int4 slope. Then qualify the downloaded Nightmedia Qwen 3.6 27B Polaris revision `721c71607072ecc0f0904db862d64ea1d0ac59fb` with an explicit `--force-hybrid` smoke gate before any context/estimator conclusion.
