...
pub fn static_routes() -> impl warp::Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    ...
    let route_18 = warp::path("icon.svg")
        .and(warp::get())
    ...
    let route_66 = warp::path("manifest.json")
        .and(warp::get())
