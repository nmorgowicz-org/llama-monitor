...
| Phase 4 shared view descriptor relocation | Not started | Pro remains explicitly unavailable; preflight removed the hard-coded Guided settings count and now derives disclosure count from the shared control registry. Full canonical relocation, Pro renderer, and view-switch contract remain. |
