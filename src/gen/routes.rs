...
-> impl warp::Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    ...
    let route_16 = warp::path("icon.svg")
        .and(warp::get())
    ...
    let route_62 = warp::path("manifest.json")
        .and(warp::get())
    ...
    .or(
        ...
        .or(
            (((route_30).or(route_31)).or((route_32).or((route_33).or(route_34))))
                .or(((route_35).or(route_36)).or((route_37).or((route_38).or(route_39)))),
        ),
    ))
    .or(
        (((((route_40).or(route_41)).or((route_42).or((route_43).or(route_44))))
            .or(((route_45).or(route_46)).or((route_47).or((route_48).or(route_49)))))
        .or(
            (((route_50).or(route_51)).or((route_52).or((route_53).or(route_54))))
                .or(((route_55).or(route_56)).or((route_57).or((route_58).or(route_59)))),
        ))
        .or(
            ((((route_60).or(route_61)).or((route_62).or((route_63).or(route_64))))
                .or(((route_65).or(route_66)).or((route_67).or((route_68).or(route_69)))))
            .or(
                (((route_70).or(route_71)).or((route_72).or((route_73).or(route_74))))
