...
-> impl warp::Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    ...
    let route_83 = warp::path("manifest.json")
        .and(warp::get())
    ...
    .or((((route_39).or((route_40).or(route_41)))
        .or(((route_42).or(route_43)).or((route_44).or(route_45))))
    .or(((route_46).or((route_47).or(route_48)))
        .or(((route_49).or(route_50)).or((route_51).or(route_52)))))))
    .or(
        (((((route_53).or((route_54).or(route_55))).or((route_56).or((route_57).or(route_58))))
            .or(((route_59).or((route_60).or(route_61)))
                .or(((route_62).or(route_63)).or((route_64).or(route_65)))))
        .or(
            (((route_66).or((route_67).or(route_68))).or((route_69).or((route_70).or(route_71))))
                .or(((route_72).or((route_73).or(route_74)))
                    .or(((route_75).or(route_76)).or((route_77).or(route_78)))),
        ))
        .or(((((route_79).or((route_80).or(route_81)))
            .or((route_82).or((route_83).or(route_84))))
        .or(((route_85).or((route_86).or(route_87)))
            .or(((route_88).or(route_89)).or((route_90).or(route_91)))))
        .or((((route_92).or((route_93).or(route_94)))
            .or(((route_95).or(route_96)).or((route_97).or(route_98))))
        .or(((route_99).or((route_100).or(route_101)))
