...
-> impl warp::Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    ...
    let route_78 = warp::path("manifest.json")
        .and(warp::get())
    ...
    .or(
        (((route_88).or((route_89).or(route_90))).or((route_91).or((route_92).or(route_93))))
            .or(((route_94).or((route_95).or(route_96)))
