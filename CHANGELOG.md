...
* **api:** new endpoints for MTP-draft check, HF token, streaming download, VRAM breakdown, chat-templates, and session readiness. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **api:** restore 27 spawn-wizard handler functions to prevent mass 404s on wizard/HF/tuning endpoints. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **chat:** multi-select in conversations sidebar with bulk Delete/Archive and Undo toasts. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **chat:** new chat preferences (date format, Enter-to-send, context view, persist-thinking-content, etc.). ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **chat:** raised new-tab max_tokens default from 8192 to 32768 for longer conversations. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **chat:** streaming render throttled to ≤20 fps to prevent main-thread freezes on long responses. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **hf:** discover-pills for major families (Qwen3, Llama3, Mistral/MoE, Gemma, EXAONE, etc.) and per-author browsing. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **hf:** full HuggingFace integration with keyword search, sort (trending/downloads/likes/newest), and load-more. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **hf:** GGUF file listing with real sizes, mmproj/draft-model detection, and provider/quant-type labels. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **hf:** HF token integration (store/show/remove) for gated repos; token never echoed in responses. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **hf:** streaming downloads with resume, ETA, cancel, and partial-file rename safety. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **models:** library tag system: attach/click-remove tags per model; filter by tags (coding, roleplay, etc.). ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **models:** model-library view with card/list modes, search, filters (quant, size, tag, mmproj, split, draft), and persisted prefs. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **models:** per-model VRAM bar and estimate, plus related-presets linking on each model card. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **perf:** 80%+ battery-drain reduction via Page Visibility API, 70+ paused CSS animations, and transform-based animations. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **perf:** Low Power Mode with configurable auto-sleep, slower pollers, and reduced WebSocket broadcast in idle/battery-saver. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **security:** login brute-force resistance: cooldown increased from 2s to 10s. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **security:** metrics and GPU/system endpoints now require api_token; Host header spoofing protection. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **security:** multi-statement SQL rejection in DB query endpoint; tightened body-size and repo_id validations. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **security:** path-traversal guards for HF downloads, model browse, and resolve-origin with unit tests. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** always-on flags for long conversations: --no-context-shift, --ctx-checkpoints, --keep now default. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** bind host (loopback vs 0.0.0.0) and per-session API key configuration for safer local use. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** echo llama-server logs to terminal and attach last lines on spawn failure for clearer diagnostics. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** pre-spawn health check (run llama-server --help) with captured stderr; fail fast on bad binary. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** race-safe restart-after-update with server_stopping flag, MTP port-sweep cleanup, and improved timeouts. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** unified V2 spawn architecture using -m or -hf model source with validation and clear errors. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **tuning:** MTP n-max sweep with bar chart and one-click apply; MoE auto-tune and depth sweep via llama-bench. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **tuning:** new tuning panel with performance benchmark (A/B/C/D grades) and auto-tuning suggestions. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **ui:** control bar redesign with two-zone layout and context-aware buttons (Running→Stop+Switch / Stopped→Start+Spawn). ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **ui:** full light theme pass with contrast-safe colors; reduced-motion queries disable transitions for accessibility. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **ui:** logs panel overhaul with token coloring, font size controls, incremental rendering, and live log tail viewer. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **ui:** post-stop choice modal: "Go to Welcome" or "Stay on Dashboard". ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **ui:** teal accent retheme across hardware cards, inference widgets, logs, and navigation. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **ui:** welcome screen redesign: preset launch grid, recent-launch timestamps, unified memory bar, and drop-zone. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** architecture-aware VRAM estimator rewrite with direct GGUF metadata read, no subprocess needed. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** DeltaNet/hybrid-attention support for Qwen3.6, Qwen3.5, Qwen3-Coder-Next, davidau 40B. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** EXAONE 4.5 family support including hybrid attention, MTP depth, and vision encoder sizing. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** Gemma 3/4 sliding-window and Gemma 4 global head_dim modeling for accurate KV cache estimates. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** MoE support with VRAM/RAM split based on n_cpu_moe, expert_fraction, and MoE auto-tune suggestions. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** VRAM fit legend, inline context-size warnings, and "approx." labeling on launch cards. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** animated VRAM breakdown panel with MoE expert offload slider and per-component tooltips. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** Apple Silicon P/E core detection, unified memory budget model, and Metal GPU limit control. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** auto-advance with toast after HF download completes; quick-edit chips open preset modal on context. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** auto-resolve HF origin for local models with model card panel and markdown-rendered details. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** chat template auto-install, cache_ram_mib, and full preset field wiring to spawn. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** context quick-picks up to 256k with free manual input and minimum-context warnings. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** five-step Spawn Wizard (Profile → Model → Hardware & Tuning → Summary → Spawn) with guided, VRAM-aware defaults and hardware presets. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** integrated HuggingFace search/browse/download into the spawn flow—browse, pick, and launch from one wizard. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** Profile segmented control (Quick/Balanced/Advanced) and use-case selection persisted in localStorage. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** quant swap step with VRAM-aware advisor, provider presets, and in-place quant changes without recreating presets. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** server alias and extra args in Summary; modernized footer and Close button. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** speculative decoding, MTP/assistant model support, and draft-model auto-detection for Gemma4/Qwen3.6. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** thinking/reasoning controls, Qwen3.5/3.6 reasoning presets, and reasoning budget options. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **security:** fix token leak and header-spoofing issue in bootstrap-token and setup checks. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** enable flash attention by default for eligible models; preset editor reflects new standard. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** prevent locally spawned servers from leaking into remote endpoints list. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **spawn:** remove 30s cooldown from kill-llama; unify stop/kill for faster session cycling and safer restart loops. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **vram:** correct Gemma4 and Qwen DeltaNet heuristics (n_ctx_train integration, expert semantics) for accurate estimates. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
...
* **wizard:** correct -ngl 99 to -ngl all; ensure wizard maps "All" to -1 safely across llama.cpp versions. ([ece1446](https://github.com/nmorgowicz-org/llama-monitor/commit/ece14466eeec257c8bcb8e54fab155866d508e9b))
