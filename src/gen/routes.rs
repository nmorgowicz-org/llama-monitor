...
-> impl warp::Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    ...
    let route_15 = warp::path("icon.svg")
        .and(warp::get())
    ...
    let route_60 = warp::path("manifest.json")
        .and(warp::get())
    ...
    .or(
        (((((route_39).or(route_40)).or((route_41).or((route_42).or(route_43))))
            .or(((route_44).or(route_45)).or((route_46).or((route_47).or(route_48)))))
        .or(
            (((route_49).or(route_50)).or((route_51).or((route_52).or(route_53))))
                .or(((route_54).or(route_55)).or((route_56).or((route_57).or(route_58)))),
        ))
        .or(
            ((((route_59).or(route_60)).or((route_61).or((route_62).or(route_63))))
                .or(((route_64).or(route_65)).or((route_66).or((route_67).or(route_68)))))
            .or(
                (((route_69).or(route_70)).or((route_71).or((route_72).or(route_73))))
                    .or(((route_74).or(route_75)).or((route_76).or((route_77).or(route_78)))),
            ),
        ),
    )
}
